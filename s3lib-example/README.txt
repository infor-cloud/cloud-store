...
To load a new s3lib*.jar file into the local repo, do something like:
   ...
   tar xfz s3lib.tgz
   mvn install:install-file -Dfile=s3lib-267_43193082ee6a/lib/java/s3lib-0.2.jar -DgroupId=com.logicblox -DartifactId=s3lib -Dversion=0.2.267 -Dpackaging=jar -DgeneratePom=true
