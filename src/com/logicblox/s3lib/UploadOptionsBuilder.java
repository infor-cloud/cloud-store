...
public class UploadOptionsBuilder {
	...
	private Optional<String> kmsEncKey = Optional.absent();
	private Optional<String> acl = Optional.absent();
	private Optional<OverallProgressListenerFactory> overallProgressListenerFactory = Optional
			.absent();
	...
	public UploadOptionsBuilder setKmsEncKey(String kmsEncKey) {
		this.kmsEncKey = Optional.fromNullable(kmsEncKey);
		return this;
	}
	...
	public UploadOptionsBuilder setOverallProgressListenerFactory(
		...
		this.overallProgressListenerFactory = Optional
				.fromNullable(overallProgressListenerFactory);
		return this;
	}

	public UploadOptions createUploadOptions() {
		return new UploadOptions(file, bucket, objectKey, encKey, kmsEncKey,
