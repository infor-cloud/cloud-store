...
To load a new s3lib*.jar file into the local repo, do something like:
   ...
   tar xfz s3lib.tgz
   mvn install:install-file -Dfile=s3lib-272_2dab7d1c9c69/lib/java/s3lib-0.2.jar -DgroupId=com.logicblox -DartifactId=s3lib -Dversion=0.2.272 -Dpackaging=jar -DgeneratePom=true
